...
(cl:defmethod header-val ((m <SaveSensorData>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SaveSensorData>)))
  ...
  "2ea26c4b6cccd1ac8432c50be268450c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SaveSensorData)))
  "Returns md5sum for a message object of type 'SaveSensorData"
  "2ea26c4b6cccd1ac8432c50be268450c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SaveSensorData>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%bool is_custom_file_name~%string custom_file_name~%string file_dir~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SaveSensorData)))
  "Returns full string definition for message of type 'SaveSensorData"
  (cl:format cl:nil "std_msgs/Header header~%~%bool is_custom_file_name~%string custom_file_name~%string file_dir~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
