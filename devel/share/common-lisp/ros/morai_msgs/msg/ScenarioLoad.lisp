...
(cl:defmethod header-val ((m <ScenarioLoad>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ScenarioLoad>)))
  ...
  "946c9575c5f571a236ffb2bd542541cc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ScenarioLoad)))
  "Returns md5sum for a message object of type 'ScenarioLoad"
  "946c9575c5f571a236ffb2bd542541cc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ScenarioLoad>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%string file_name~%bool delete_all~%bool load_network_connection_data~%bool load_ego_vehicle_data~%bool load_surrounding_vehicle_data~%bool load_pedestrian_data~%bool load_obstacle_data~%bool set_pause~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ScenarioLoad)))
  "Returns full string definition for message of type 'ScenarioLoad"
  (cl:format cl:nil "std_msgs/Header header~%~%string file_name~%bool delete_all~%bool load_network_connection_data~%bool load_ego_vehicle_data~%bool load_surrounding_vehicle_data~%bool load_pedestrian_data~%bool load_obstacle_data~%bool set_pause~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
