...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EventInfo>)))
  ...
  "e8aa06e7501f043540d447309a9f019f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EventInfo)))
  "Returns md5sum for a message object of type 'EventInfo"
  "e8aa06e7501f043540d447309a9f019f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EventInfo>)))
  ...
  (cl:format cl:nil "int8 option~%int32 ctrl_mode~%int32 gear~%Lamps lamps~%bool set_pause~%~%================================================================================~%MSG: morai_msgs/Lamps~%std_msgs/Header header~%~%int8 turn_signal~%int8 emergency_signal~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EventInfo)))
  "Returns full string definition for message of type 'EventInfo"
  (cl:format cl:nil "int8 option~%int32 ctrl_mode~%int32 gear~%Lamps lamps~%bool set_pause~%~%================================================================================~%MSG: morai_msgs/Lamps~%std_msgs/Header header~%~%int8 turn_signal~%int8 emergency_signal~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
