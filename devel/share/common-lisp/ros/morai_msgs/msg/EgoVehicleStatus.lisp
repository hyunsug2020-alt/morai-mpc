...
(cl:defclass <EgoVehicleStatus> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (distance_left_lane_boundary
    :reader distance_left_lane_boundary
    :initarg :distance_left_lane_boundary
    :type cl:float
    :initform 0.0)
   (distance_right_lane_boundary
    :reader distance_right_lane_boundary
    :initarg :distance_right_lane_boundary
    :type cl:float
    :initform 0.0)
   (cross_track_error
...
(cl:defmethod angular_velocity-val ((m <EgoVehicleStatus>))
...
(cl:defmethod front_steer-val ((m <EgoVehicleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:front_steer-val is deprecated.  Use morai_msgs-msg:front_steer instead.")
  (front_steer m))

(cl:ensure-generic-function 'rear_steer-val :lambda-list '(m))
(cl:defmethod rear_steer-val ((m <EgoVehicleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:rear_steer-val is deprecated.  Use morai_msgs-msg:rear_steer instead.")
  (rear_steer m))
...
(cl:ensure-generic-function 'distance_left_lane_boundary-val :lambda-list '(m))
(cl:defmethod distance_left_lane_boundary-val ((m <EgoVehicleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:distance_left_lane_boundary-val is deprecated.  Use morai_msgs-msg:distance_left_lane_boundary instead.")
  (distance_left_lane_boundary m))

(cl:ensure-generic-function 'distance_right_lane_boundary-val :lambda-list '(m))
(cl:defmethod distance_right_lane_boundary-val ((m <EgoVehicleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:distance_right_lane_boundary-val is deprecated.  Use morai_msgs-msg:distance_right_lane_boundary instead.")
  (distance_right_lane_boundary m))

(cl:ensure-generic-function 'cross_track_error-val :lambda-list '(m))
(cl:defmethod cross_track_error-val ((m <EgoVehicleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:cross_track_error-val is deprecated.  Use morai_msgs-msg:cross_track_error instead.")
  (cross_track_error m))
...
(cl:defmethod gear-val ((m <EgoVehicleStatus>))
...
(cl:defmethod ctrl_mode-val ((m <EgoVehicleStatus>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EgoVehicleStatus>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'tire_cornering_stiffness_rr))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'distance_left_lane_boundary))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'distance_right_lane_boundary))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'cross_track_error))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'wheel_angle))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EgoVehicleStatus>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'angular_velocity) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'distance_left_lane_boundary) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'distance_right_lane_boundary) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'cross_track_error) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'wheel_angle) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EgoVehicleStatus>)))
  ...
  "805ccb1a6ed8e5235a26921c3f7a53d5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EgoVehicleStatus)))
  "Returns md5sum for a message object of type 'EgoVehicleStatus"
  "805ccb1a6ed8e5235a26921c3f7a53d5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EgoVehicleStatus>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%int32 unique_id~%geometry_msgs/Vector3 acceleration~%geometry_msgs/Vector3 position~%geometry_msgs/Vector3 velocity~%geometry_msgs/Vector3 angular_velocity~%~%float64 heading~%float64 accel~%float64 brake~%float64 front_steer~%float64 rear_steer~%~%float32 tire_lateral_force_fl~%float32 tire_lateral_force_fr~%float32 tire_lateral_force_rl~%float32 tire_lateral_force_rr~%~%float32 side_slip_angle_fl~%float32 side_slip_angle_fr~%float32 side_slip_angle_rl~%float32 side_slip_angle_rr~%~%float32 tire_cornering_stiffness_fl~%float32 tire_cornering_stiffness_fr~%float32 tire_cornering_stiffness_rl~%float32 tire_cornering_stiffness_rr~%~%float32 distance_left_lane_boundary~%float32 distance_right_lane_boundary~%float32 cross_track_error~%~%float64 wheel_angle~%int32 gear~%int32 ctrl_mode~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EgoVehicleStatus)))
  "Returns full string definition for message of type 'EgoVehicleStatus"
  (cl:format cl:nil "std_msgs/Header header~%~%int32 unique_id~%geometry_msgs/Vector3 acceleration~%geometry_msgs/Vector3 position~%geometry_msgs/Vector3 velocity~%geometry_msgs/Vector3 angular_velocity~%~%float64 heading~%float64 accel~%float64 brake~%float64 front_steer~%float64 rear_steer~%~%float32 tire_lateral_force_fl~%float32 tire_lateral_force_fr~%float32 tire_lateral_force_rl~%float32 tire_lateral_force_rr~%~%float32 side_slip_angle_fl~%float32 side_slip_angle_fr~%float32 side_slip_angle_rl~%float32 side_slip_angle_rr~%~%float32 tire_cornering_stiffness_fl~%float32 tire_cornering_stiffness_fr~%float32 tire_cornering_stiffness_rl~%float32 tire_cornering_stiffness_rr~%~%float32 distance_left_lane_boundary~%float32 distance_right_lane_boundary~%float32 cross_track_error~%~%float64 wheel_angle~%int32 gear~%int32 ctrl_mode~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EgoVehicleStatus>))
  ...
  (cl:list 'EgoVehicleStatus
    ...
    (cl:cons ':distance_left_lane_boundary (distance_left_lane_boundary msg))
    (cl:cons ':distance_right_lane_boundary (distance_right_lane_boundary msg))
