...
(cl:defmethod header-val ((m <MapSpec>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MapSpec>)))
  ...
  "5c1bf7f48b811f19454aab0f3c24f18f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MapSpec)))
  "Returns md5sum for a message object of type 'MapSpec"
  "5c1bf7f48b811f19454aab0f3c24f18f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MapSpec>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%int32 plane_coordinate_system~%int32 utm_num~%~%geometry_msgs/Vector3 utm_offset~%~%string ellipse~%float64 central_latitude~%float64 central_meridian~%float64 scale_factor~%float64 false_easting~%float64 false_northing~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MapSpec)))
  "Returns full string definition for message of type 'MapSpec"
  (cl:format cl:nil "std_msgs/Header header~%~%int32 plane_coordinate_system~%int32 utm_num~%~%geometry_msgs/Vector3 utm_offset~%~%string ellipse~%float64 central_latitude~%float64 central_meridian~%float64 scale_factor~%float64 false_easting~%float64 false_northing~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
