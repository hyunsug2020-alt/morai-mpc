...
class TrafficLightIndex {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrafficLightIndex(null);
  ...
  static datatype() {
    ...
    return 'morai_msgs/TrafficLightIndex';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'ce6b633ce00ebf1b48574d33845dbe8b';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrafficLightIndex(null);
...
module.exports = TrafficLightIndex;
