...
class MoraiSimProcHandle(genpy.Message):
  _md5sum = "4f90a190f9ea5b4fff26f1a9a37d16eb"
...
string frame_id
"""
  __slots__ = ['header','sim_process_status','replay_option','rosbag_file_name','replay_target_option','replay_speed','start_time']
  _slot_types = ['std_msgs/Header','uint8','int16','string','int16','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,sim_process_status,replay_option,rosbag_file_name,replay_target_option,replay_speed,start_time
