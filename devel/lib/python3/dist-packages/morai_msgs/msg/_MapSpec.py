...
class MapSpec(genpy.Message):
  _md5sum = "5c1bf7f48b811f19454aab0f3c24f18f"
...
float64 y
float64 z"""
  __slots__ = ['header','plane_coordinate_system','utm_num','utm_offset','ellipse','central_latitude','central_meridian','scale_factor','false_easting','false_northing']
  _slot_types = ['std_msgs/Header','int32','int32','geometry_msgs/Vector3','string','float64','float64','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,plane_coordinate_system,utm_num,utm_offset,ellipse,central_latitude,central_meridian,scale_factor,false_easting,false_northing
