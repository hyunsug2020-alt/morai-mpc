...
class EventInfo(genpy.Message):
  _md5sum = "e8aa06e7501f043540d447309a9f019f"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2bB().pack(_x.lamps.turn_signal, _x.lamps.emergency_signal, _x.set_pause))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.lamps.turn_signal, _x.lamps.emergency_signal, _x.set_pause,) = _get_struct_2bB().unpack(str[start:end])
